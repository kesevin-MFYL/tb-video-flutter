...
class InterstitialAdManager {
  ...
  void showAdIfAvailable(String scenario, {ValueChanged<bool>? onAdDismissed}) {
    ...
    // 取出对应场景的广告实例
    final ad = _interstitialAds[scenario]!;
  ...
  void disposeAd(String scenario) {
    _interstitialAds[scenario]?.dispose();
    _interstitialAds.remove(scenario);
    _interstitialLoadTimes.remove(scenario);
  }
}
