...
/// 剧集弹窗(横屏)
class TvSeasonSingleDialog extends StatefulWidget {
  final MediaDetailSingleController controller;

  const TvSeasonSingleDialog({super.key, required this.controller});

  @override
  State<TvSeasonSingleDialog> createState() => _TvSeasonSingleDialogState();
}

class _TvSeasonSingleDialogState extends State<TvSeasonSingleDialog> {
  @override
