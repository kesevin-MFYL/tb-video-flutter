...
/// 剧集弹窗(横屏)
class VideoAnimeEpisodeDialog extends StatefulWidget {
  final VideoDetailController controller;

  const VideoAnimeEpisodeDialog({super.key, required this.controller});

  @override
  State<VideoAnimeEpisodeDialog> createState() => _VideoAnimeEpisodeDialogState();
}

class _VideoAnimeEpisodeDialogState extends State<VideoAnimeEpisodeDialog> {
  @override
