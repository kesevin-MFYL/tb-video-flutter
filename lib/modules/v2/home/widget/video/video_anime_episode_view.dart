...
class VideoAnimeEpisodeView extends StatelessWidget {
  const VideoAnimeEpisodeView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(left: needAdapted ? 16.w : 16, right: needAdapted ? 16.w : 16, bottom: needAdapted ? 16.w : 16),
          child: Row(
            children: [
              if (!isDialog) ...[
              ...
              if (!isDialog)
                CommonButton(
                  ...
                  onPressed: controller.bottomEposidesChanged,
                  child: CommonText.instance(
                    'View ${controller.episodeList.length}',
                    12.sp,
                    color: CommonColors.primaryColor,
                ...
                CommonButton(
                  ...
                  onPressed: () {
                    if (needAdapted) {
                      controller.bottomEposidesChanged();
                    } else {
