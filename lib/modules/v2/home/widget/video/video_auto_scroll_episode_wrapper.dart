...
class VideoAutoScrollEpisodeWrapper extends StatefulWidget {
  ...
  const VideoAutoScrollEpisodeWrapper({
    super.key,
  ...
  @override
  State<VideoAutoScrollEpisodeWrapper> createState() => _VideoAutoScrollEpisodeWrapperState();
}

class _VideoAutoScrollEpisodeWrapperState extends State<VideoAutoScrollEpisodeWrapper> {
  ...
  @override
  void didUpdateWidget(VideoAutoScrollEpisodeWrapper oldWidget) {
