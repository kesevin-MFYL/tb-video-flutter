...
/// 字幕弹窗(横屏)
class VideoSubtitleSettingDialog extends StatefulWidget {
  final PlayerController controller;

  const VideoSubtitleSettingDialog({super.key, required this.controller});

  @override
  State<VideoSubtitleSettingDialog> createState() => _VideoSubtitleSettingDialogState();
}

class _VideoSubtitleSettingDialogState extends State<VideoSubtitleSettingDialog> {
