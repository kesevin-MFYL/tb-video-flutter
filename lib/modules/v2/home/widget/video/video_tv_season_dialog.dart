...
/// 剧集弹窗(横屏)
class VideoTvSeasonDialog extends StatefulWidget {
  final VideoDetailController controller;

  const VideoTvSeasonDialog({super.key, required this.controller});

  @override
  State<VideoTvSeasonDialog> createState() => _VideoTvSeasonDialogState();
}

class _VideoTvSeasonDialogState extends State<VideoTvSeasonDialog> {
  @override
