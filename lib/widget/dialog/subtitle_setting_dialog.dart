          ...
          return Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 8),
                CommonText.instance('Turn Off Subtitles', 14, fontWeight: CommonFontWeight.medium),
                Spacer(),
                Switch(
                  value: openCaptions,
                  activeColor: CommonColors.white,
                  activeTrackColor: CommonColors.primaryColor,
                  onChanged: (val) {
                    widget.controller.setSubtitle(isOpen: val);
                  },
                ),
              ],
            ),
